...
export const metadata = {
  title: "About Us | Trusted Studio Apartment Experts in Gurgaon | Gurugram",
  description:
    "We are Gurgaon's trusted studio apartment platform with 1000+ verified listings, 150+ premium projects & 3000+ happy investors. Find the best studio flats & 1RK apartments in Gurugram with expert guidance & high ROI options.",
  keywords: [
