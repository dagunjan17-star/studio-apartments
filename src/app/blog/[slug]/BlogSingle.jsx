...
export default function BlogDetails({ post }) {
  ...
  return (
    <div className="max-w-6xl mx-auto gap-10 px-4 py-10 bg-gradient-to-b from-white to-[#E6FFFA]">
      {/* LEFT SIDE */}
      <div className="mb-6">
   <Breadcrumb />
  </div>
      <article className="space-y-12">
        ...
        <div className="w-full flex justify-center pt-2">
          <div className="w-full">
            ...
            {/* IMAGE */}
            <div className="max-w-5xl mx-auto h-[260px] md:h-[480px] bg-white md:rounded-2xl overflow-hidden 
          ...
          {single.Content?.map((section) => (
            ...
            <div key={section?._id}>
              ...
              <div className="quill-content">
                <div
  className="ql-editor !p-0 text-gray-800 leading-relaxed max-w-5xl mx-auto
            ...
            <div className="mt-16">
              ...
              <div className="space-y-5 max-w-5xl mx-auto">
                ...
                {single.FAQs.map((faq, i) => (
                  <details
                    key={i}
                    className="group bg-white border border-[#3BC1A8]/10 rounded-xl p-5 
                    shadow-sm hover:shadow-md transition duration-300"
                  >

                    <summary className="flex justify-between items-center cursor-pointer list-none">

                      <span className="font-semibold text-gray-900 group-hover:text-[#3BC1A8] transition">
                        {faq.Q}
                      </span>

                      <span className="ml-4 text-[#249E94] transition-transform duration-300 group-open:rotate-180">
                        ▼
                      </span>
                    </summary>

                    <div className="mt-3 text-gray-600 leading-relaxed border-t border-[#3BC1A8]/10 pt-3">
                      {faq.A}
                    </div>
