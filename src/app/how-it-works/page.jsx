import StudioApartmentHero from "./StudioApartmentHero";
import StudioFAQ from "./StudioFAQ";

// ✅ SEO METADATA
export const metadata = {
  title: "How It Works | Buy Studio Apartment in Gurgaon Easily | No Middleman",

  description:
    "Find your perfect studio apartment in Gurgaon in easy steps. Browse verified listings, connect directly with sellers, no broker fees & book a free site visit. Simple & safe process for buying studio flats in Gurugram.",
